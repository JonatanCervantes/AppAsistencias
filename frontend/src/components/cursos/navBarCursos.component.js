        ...
        <nav className="navbar navbar-dark bg-dark navbar-expand-lg">            
            <div className="collapse navbar-collapse">
                <ul className="navbar-nav mr-auto" >
                    ...
                    <li className="navbar-item"><Link to="/cursos/eliminar" className="nav-link">Eliminar</Link></li>
                    <li className="navbar-item"><Link to="/cursos/modificar" className="nav-link">Modificar</Link></li>    
                </ul>
            </div>
        </nav>
    );    
